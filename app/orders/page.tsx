    ...
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-7xl px-6 py-8 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">View and track all your maritime service orders</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            You haven't placed any orders yet. Start by requesting a quote for our services.
          </p>
          <Link
            href="/services"
